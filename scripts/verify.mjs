...
for(const route of ['/install-status','/install/finish','/install/integration-status','/system/integration-status','/auth/magic-link','/workflow/transition','/health']) if(!api.includes(route)) failures.push(`Missing route ${route}`);
