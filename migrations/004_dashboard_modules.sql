...
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS updated_at timestamptz DEFAULT now(), ADD COLUMN IF NOT EXISTS quote_id uuid REFERENCES quotes(id), ADD COLUMN IF NOT EXISTS deposit_cents int DEFAULT 0, ADD COLUMN IF NOT EXISTS paid_cents int DEFAULT 0;
