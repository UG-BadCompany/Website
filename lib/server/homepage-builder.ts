...
const defaultGlobalStyles = { maxPageWidth: 1180, sectionSpacingDefault: 88, buttonStyle: 'pill', cardRadius: 24, background: '#f6f3ee', fontStyle: 'Inter/System', animation: DEFAULT_ANIMATION_SETTINGS, animationSettings: DEFAULT_ANIMATION_SETTINGS, header: { heroUnderHeader: true, transparentHeader: false, stickyEstimateCta: true }, footer: { showContactInfo: true, showServiceArea: true, showBusinessHours: true }, sectionDefaults: {}, homepageLayout: {}, media: {}, reviews: {}, preset: {} };
