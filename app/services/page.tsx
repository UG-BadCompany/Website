...
import { serviceCategories } from "../components/data";

export const metadata: Metadata = {
  title: "Services",
  description: "T&A Contracting service categories for Arizona home repairs, rental maintenance, painting, fixture work, installations, and improvements.",
};
