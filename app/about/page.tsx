  ...
  return (
    <section className="section-wrap page-top split">
      ...
      <div className="stacked-cards">
        <article className="card"><h2>Professional</h2><p>Clear requests, quote records, status updates, documentation, and payment workflows are planned from the start.</p></article>
