  ...
  app.innerHTML = `
    <main class="public-home premium-home" id="top">
      ...
      <header class="public-header premium-header">
        <div class="brand" onclick="window.scrollTo({top:0,behavior:'smooth'})">
          ...
          <div>
            ...
            <div class="workspace">${escapeHtml(info.serviceArea || 'Professional Services')}</div>
          </div>
        </div>
        ...
        <nav class="public-nav">
          ...
          <a href="/dashboard" class="nav-cta">Client Portal</a>
        </nav>
      ...
      <section class="premium-hero">
        <div class="hero-copy">
          <span class="eyebrow animate-in">🏆 Award-Winning Contractor Platform</span>
          ...
          <div class="hero-actions animate-in">
            ...
            ${phone ? `<a href="tel:${escapeHtml(phone)}" class="btn-secondary">
              <button class="secondary hero-phone-button">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <aside class="hero-card animate-in">
          ...
          <b>🚀 Smart Project Management</b>
          <p>Experience the future of contractor services with AI-powered estimates, real-time tracking, and seamless communication.</p>
      ...
      <section id="services" class="public-section services-section">
        <div class="section-head">
          ...
          <h2>Expert Solutions for Every Project</h2>
          <p>From small repairs to complete renovations, we deliver exceptional craftsmanship with modern project management.</p>
        </div>
          ...
          ${serviceList.slice(0, 12).map((s, i) => `
            <article class="service-tile" style="animation-delay: ${i * 0.05}s">
              <div class="service-icon-wrapper">
                <span class="service-icon" style="background: ${s.color || 'var(--primary)'}">${escapeHtml(s.icon || '🛠️')}</span>
              </div>
              <h3>${escapeHtml(s.name)}</h3>
              <p>${escapeHtml(s.category || 'Professional Service')}</p>
              <div class="service-hover-effect"></div>
              <a href="${escapeHtml(ctaLink)}" class="service-link">Learn More →</a>
            </article>
          `).join('')}
        </div>
      </section>
      ...
      <!-- Process Section -->
      <section id="process" class="public-section process-section">
        <div class="section-head">
          <span class="eyebrow">How It Works</span>
          <h2>Simple, Transparent Process</h2>
          <p>From first contact to project completion, we make it easy.</p>
        </div>
        ...
        <div class="process-grid">
          <div class="process-step">
            ...
            <p>Fill out our quick form or call us. Get a response within hours, not days.</p>
          </div>
          <div class="process-step">
            <div class="step-number">2</div>
            <div class="step-icon">💰</div>
            <h3>Receive Quote</h3>
            <p>Get a detailed, transparent quote with no hidden fees. AI-powered accuracy.</p>
          </div>
          <div class="process-step">
            <div class="step-number">3</div>
            <div class="step-icon">📅</div>
            <h3>Schedule Work</h3>
            <p>Choose a time that works for you. Real-time calendar integration.</p>
          </div>
          <div class="process-step">
            <div class="step-number">4</div>
            <div class="step-icon">✨</div>
            <h3>Project Complete</h3>
            <p>Track progress live, approve work, and pay securely online.</p>
          </div>
        </div>
      </section>
      ...
      <section id="why" class="public-section split-section">
        <div class="split-content">
          ...
          <h2>Technology Meets Craftsmanship</h2>
          <p>${escapeHtml(info.description || 'We combine decades of hands-on experience with cutting-edge project management technology to deliver results that exceed expectations.')}</p>
          
          <div class="feature-highlights">
            <div class="highlight-item">
              <div class="highlight-icon">🎯</div>
              <div>
                <h4>Precision Estimates</h4>
                <p>AI-powered quoting for accurate pricing</p>
              </div>
            </div>
            <div class="highlight-item">
              <div class="highlight-icon">📱</div>
              <div>
                ...
                <p>Track your project from anywhere</p>
              </div>
            </div>
            <div class="highlight-item">
        ...
        <div class="feature-list">
          <div class="feature-item">
            ...
            <span>Instant online estimates with photo upload</span>
          </div>
          <div class="feature-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>Digital quotes, invoices, and contracts</span>
          </div>
          <div class="feature-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
            </svg>
            <span>Live work order tracking and notifications</span>
          </div>
          <div class="feature-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>Photo documentation and progress galleries</span>
          </div>
          <div class="feature-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span>Secure online payments and financing options</span>
          </div>
          <div class="feature-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <section id="testimonials" class="public-section testimonials-section">
        <div class="section-head">
        ...
        <div class="testimonials-grid">
          <div class="testimonial-card">
            <div class="stars">⭐⭐⭐⭐⭐</div>
            <p>"The online estimate process was incredibly easy. I uploaded photos, got a quote in 2 hours, and scheduled everything from my phone. The work was flawless!"</p>
          ...
          <div class="testimonial-card">
            <div class="stars">⭐⭐⭐⭐⭐</div>
            <p>"I loved being able to track the progress in real-time. The team sent photos every day and the final result exceeded my expectations. Highly recommend!"</p>
            <div class="testimonial-author">
              <div class="author-avatar">MR</div>
              <div>
                <b>Michael Rodriguez</b>
          ...
          <div class="testimonial-card">
            <div class="stars">⭐⭐⭐⭐⭐</div>
            <p>"Professional, punctual, and the quality is outstanding. The digital invoice and payment system made everything so convenient. Will definitely use again!"</p>
            <div class="testimonial-author">
              <div class="author-avatar">SK</div>
              <div>
                <b>Sarah Kim</b>
                <span>Home Office Build</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="contact" class="public-section contact-band">
        <div class="contact-content">
          ...
          <p>${escapeHtml(info.businessHours || 'Get a free estimate today. No obligation, no pressure—just honest advice and transparent pricing.')}</p>
        </div>
      ...
      <footer class="premium-footer">
        <div class="footer-content">
          <div class="footer-brand">
            ...
            <b>${escapeHtml(companyName)}</b>
            <p>${escapeHtml(info.serviceArea || 'Professional contractor services powered by modern technology')}</p>
          ...
          <div class="footer-links">
            ...
            <div>
              ...
              ${info.serviceArea ? `<p class="muted">Serving ${escapeHtml(info.serviceArea)}</p>` : ''}
            </div>
          </div>
        </div>
...
function bindInputs(){
  $$('[data-field]').forEach(el=>{ el.oninput=()=>{ if(el.classList.contains('hex-input') && !/^#[0-9a-fA-F]{6}$/.test(el.value)) return; setDraft(el.dataset.field, el.type==='checkbox'?el.checked:el.value); if(el.dataset.field.startsWith('theme.')){ setDraft('theme.updated_at', new Date().toISOString()); applyTheme(); } }; });
...
function updateTheme(values){ state.draft.theme={...(state.draft.theme||{}),...values}; saveLocalDraft(); scheduleDraftSave(); applyTheme(); }
...
function persistServices(render=true){ state.draft.services.items=services(); state.draft.services.list=services().map(s=>s.name).join(', '); saveLocalDraft(); scheduleDraftSave(); }
...
function persistHomepage(render=true){ saveLocalDraft(); scheduleDraftSave(); }
...
function readAsset(e,path){ const file=e.target.files?.[0]; if(!file) return; const r=new FileReader(); r.onload=()=>{ setDraft(path,r.result); }; r.readAsDataURL(file); }
function readArrayAsset(e,path,index,key){ const file=e.target.files?.[0]; if(!file) return; const r=new FileReader(); r.onload=()=>{ const parts=path.split('.'); let node=state.draft; while(parts.length){ const p=parts.shift(); node[p] ||= parts.length ? {} : []; node=node[p]; } node[index] ||= {}; node[index][key]=r.result; saveLocalDraft(); scheduleDraftSave(); }; r.readAsDataURL(file); }
