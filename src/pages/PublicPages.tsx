...
type EstimateDraft = {
  ...
  title: string; description: string; problemStartedDate: string; workedOnBefore: string; budgetRange: string;
...
const initialEstimate: EstimateDraft = {
  ...
  title: '', description: '', problemStartedDate: '', workedOnBefore: 'no', budgetRange: '', files: [], confirmed: false,
};
