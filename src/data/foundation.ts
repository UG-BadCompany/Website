...
export const permissions: Permission[] = [
  'settings.view','settings.manage','users.view','users.manage','roles.manage','permissions.manage','clients.view','clients.manage','properties.view','properties.manage','requests.view','requests.manage','quotes.view','quotes.create','quotes.approve','quotes.manage','jobs.view','jobs.manage','work_orders.view','work_orders.manage','invoices.view','invoices.manage','payments.view','payments.manage','cmms.view','cmms.manage','messages.view','messages.manage','media.view','media.manage','homepage.manage','theme.manage','license.view','license.manage','expansion_packs.view','expansion_packs.manage'
