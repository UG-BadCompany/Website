...
When replacing a closed PR, open the new PR from this clean branch and mention that the earlier PR was closed so reviewers use this PR as the source of truth.
