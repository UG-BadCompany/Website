...
(() => {
  ...
  const tagSections = () => {
    const tags = [
      ...
      ['#smart-schedule-suite, .smart-schedule-suite', 'admin worker'],
      ['.maintenance-suite', 'admin client'],
      ['#customer-experience-center, .customer-experience-suite', 'admin client'],
      ['#worker-jobs, [data-worker-jobs], #worker-tools-upgrade, .worker-upgrade-panel', 'admin worker'],
      ['#worker-mobile-field, .worker-mobile-suite', 'admin worker'],
      ['#worker-ai-troubleshooting, [data-worker-ai-troubleshooting], .ai-troubleshooting-suite', 'admin worker'],
