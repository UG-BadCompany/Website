...
// Final cleanup layer:
// - Dark mode only
// - Removes light mode/theme toggle UI
// - Removes visible AI Quote buttons/links
// - Keeps Request Estimate as the public AI-powered estimate flow
// - Does not touch magic-link login
...
(() => {
  ...
  // Rename any leftover visible labels without changing backend file/function names.
  const replacements = [
