...
from (
  values
    ...
    ('mini_splits','Mini Splits','question','Desired BTU','Desired BTU size if known; skip if unsure.','{}'::jsonb),
    ...
    ('commercial_plumbing','Commercial Plumbing','inspection_requirement','Backflow inspection','Check backflow and local inspection requirements.','{}'::jsonb),
    ...
    ('commercial_electrical','Commercial Electrical','safety_requirement','Shutdown window','Coordinate shutdown and lockout/tagout requirements.','{}'::jsonb),
    ('roofing','Roofing','safety_requirement','Fall protection','Evaluate ladder, pitch, and fall protection needs.','{}'::jsonb),
    ...
    ('flooring','Flooring','material','Flooring material selection','Capture customer material preference, waste factor, transitions, and underlayment.','{}'::jsonb),
