...
export const normalizeWorkflowStatus = (status = '') => ({
  ...
  accepted_quote: 'waiting_assignment',
...
export const statusSet = (name) => WORKFLOW[name] || [];
...
export const WORKFLOW_EVENTS = Object.freeze(['quote:accepted', 'quote:converted', 'workorder:created', 'workorder:assigned', 'workorder:completed', 'workorder:closed', 'invoice:created', 'invoice:paid', 'payment:verified', 'inventory:updated']);
