...
const createJobFiles = async (db, context, jobRequestId, rawFiles = []) => {
  ...
  for (const file of normalizedFiles) {
    ...
    const [createdFile] = await db.sql`
      insert into files (owner_id, uploaded_by_user_id, job_request_id, request_id, customer_id, path, file_path, file_url, file_name, mime_type, file_type, size_bytes, file_size, caption, notes, photo_type, file_category, visibility, source_context, quote_id, work_order_id, photo_estimate_id, invoice_id, metadata)
