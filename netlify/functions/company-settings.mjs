...
const camel = (row = {}) => ({
  ...
  hasCustomSidebarColors: Boolean(row.sidebar_background_color || row.sidebar_text_color || row.sidebar_active_color || row.sidebar_border_color || row.sidebar_hover_color || row.mobile_nav_background_color || row.mobile_nav_text_color || row.mobile_nav_active_color || row.mobile_nav_border_color),
