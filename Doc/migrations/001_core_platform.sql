...
-- Netlify Functions apply this schema idempotently through shared/db.mjs during install and API access.
create extension if not exists pgcrypto;
-- Tables created: platform_installation, company_settings, homepage_settings, app_users, roles, permissions,
-- role_permissions, user_roles, workspace_access, module_registry, module_settings, service_categories,
